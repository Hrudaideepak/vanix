...
exports.getAdminAnalytics = async (req, res, next) => {
  try {
    // ⚡ Bolt: Batch independent Mongoose database queries using Promise.all() to execute them concurrently
    // This prevents cumulative I/O blocking and significantly reduces endpoint response time
    const [
      totalUsers,
      activeUsers,
      moviesUploaded,
