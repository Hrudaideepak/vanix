...
exports.getAdminAnalytics = async (req, res, next) => {
  try {
    // ⚡ Bolt: Batch independent MongoDB queries using Promise.all() to prevent cumulative I/O blocking
    const [
      totalUsers,
      activeUsers,
      moviesUploaded,
    ...
    // ⚡ Bolt: Calculate monthly revenue from the batched aggregation results
