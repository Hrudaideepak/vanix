...
exports.getAdminAnalytics = async (req, res, next) => {
  try {
    // ⚡ Bolt: Batch independent Mongoose queries using Promise.all() to prevent cumulative I/O blocking
    // Impact: Reduces overall wait time to the longest single query instead of the sum of all queries
